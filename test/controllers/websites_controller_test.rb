...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { after_image: @website.after_image, before_image: @website.before_image, description: @website.description, title: @website.title }
    end
  ...
  test "should update website" do
    patch :update, id: @website, website: { after_image: @website.after_image, before_image: @website.before_image, description: @website.description, title: @website.title }
    assert_redirected_to website_path(assigns(:website))
  end
